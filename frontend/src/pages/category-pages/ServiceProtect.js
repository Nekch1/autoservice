...
// const Protect = () =>{
//     return(
//         <CatalogPage categoryImg={categoryProtect} textContent={"Средства индивидуальной защиты"}/>
//     )
// }
...
const CatalogPage = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:5000/services/9')
            .then(res => res.json())
            .then(data => {
                console.log(data);
                setCategories(data);
                    ...
                    <div className="row">
                                ...
                                <div className="carousel-inner">
                                    {[0, 1, 2].map((i) => (
                                        <div key={i} className={`carousel-item ${i === 0 ? 'active' : ''}`}>
                                            <img src={categoryProtect} className="d-block w-100" alt={`Картинка ${i + 1}`} />
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="col-xl-6 col-lg-12">
                            ...
                            <div class="service-link">
                                ...
                                <Link to="/catalog/service-protect">Средства индивидуальной защиты</Link>
                                <Link to="/catalog/service-cosmetics">Автокосметика</Link>
                            </div>
                        </div>
                    </div>
                </div>
